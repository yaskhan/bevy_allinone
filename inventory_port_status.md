# Inventory Port Status (Bevy 0.18)

Source: `gkit/Scripts/Inventory/`
...
- [x] `meleeWeaponOnInventory.cs`
- [x] `objectOnInventory.cs`
- [ ] `oxygenOnInventory.cs`
- [ ] `shieldOnInventory.cs`
- [ ] `staminaOnInventory.cs`
