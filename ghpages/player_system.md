...
pub struct PlayerModesSystem {
    ...
    pub player_modes: Vec<PlayerMode>,          // List of available player modes
    ...
    pub player_control_states: Vec<PlayerControlState>, // List of available control states
...
pub struct PlayerStateSystem {
    ...
    pub player_state_list: Vec<PlayerStateInfo>, // List of all available states
...
pub struct PlayerIdleSystem {
    ...
    pub idle_info_list: Vec<IdleInfo>,          // List of available idle states
...
pub struct NavMeshOverride {
    ...
    pub target_entity: Option<Entity>,             // Optional target entity to follow
    pub target_position: Option<Vec3>,           // Optional target position to move to
...
pub struct SetNavMeshTargetEvent {
    ...
    pub target_position: Option<Vec3>, // Target world position
    pub target_entity: Option<Entity>, // Target entity to follow
}
```
...
pub struct Ragdoll {
    ...
    pub root_bone: Option<Entity>,        // Optional reference to root bone
    pub body_parts: Vec<Entity>,          // Vector of all body part entities
}
```
...
pub struct ActivateRagdollEvent {
    ...
    pub force_direction: Option<Vec3>,    // Optional direction for force application
...
pub struct UpperBodyRotation {
    ...
    pub spine_bone: Option<Entity>,           // Reference to spine bone entity
    pub chest_bone: Option<Entity>,           // Reference to chest bone entity
}
```
...
pub struct UpperBodyTarget {
    pub target_entity: Option<Entity>,        // Entity to look at
    pub target_position: Option<Vec3>,       // World position to look at
}
```
...
pub fn handle_movement_state_changes(
    mut set_state_queue: ResMut<SetPlayerStateQueue>,
    keys: Res<ButtonInput<KeyCode>>,
    query: Query<&PlayerStateSystem>,
) {
...
pub fn handle_combat_states(
    mut set_mode_queue: ResMut<SetPlayerModeQueue>,
    combat_events: Res<CombatEvents>,
    query: Query<&PlayerModesSystem>,
) {
    let player_entity = /* get player entity */;
...
pub fn handle_combat_animations(
    mut sprite_query: Query<&mut SpriteAnimator>,
    combat_events: Res<CombatEvents>,
) {
...
pub fn handle_vehicle_states(
    mut set_control_queue: ResMut<SetControlStateQueue>,
    vehicle_events: Res<VehicleEvents>,
    query: Query<&PlayerModesSystem>,
) {
    let player_entity = /* get player entity */;
...
pub fn handle_vehicle_animations(
    mut animator_query: Query<&mut SpriteAnimator>,
...
pub fn setup_ai_control(
    ...
    mut nav_override_queue: ResMut<SetNavMeshTargetQueue>,
    ai_targets: Res<AiTargets>,
) {
    let player_entity = /* get player entity */;
...
pub fn manage_ai_sequences(
    mut enable_override_queue: ResMut<EnableNavMeshOverrideQueue>,
    mut disable_override_queue: ResMut<DisableNavMeshOverrideQueue>,
    ai_state: Res<AiSequenceState>,
    query: Query<&NavMeshOverride>,
) {
    let player_entity = /* get player entity */;
...
pub fn serialize_player_state(
    query: Query<(&PlayerModesSystem, &PlayerStateSystem, &PlayerIdleSystem)>,
) -> PlayerStateData {
...
pub fn sync_player_state(
    ...
    network_events: Res<NetworkEvents>,
) {
