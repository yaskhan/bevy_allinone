...
fn my_puzzle_handler(
    mut event_queue: ResMut<PuzzleEventQueue>,
    mut solved_queue: ResMut<PuzzleSolvedEventQueue>,
) {
...
fn update_active_puzzles(
    ...
    mut puzzles: Query<(&Transform, &mut PuzzleButton), Without<Player>>,
) {
...
fn save_puzzle_progress(
    puzzles: Query<(&PuzzleProgress, &PuzzleButton)>,
...
fn open_door_on_button(
    buttons: Query<&PuzzleButton>,
    mut doors: Query<&mut Transform, With<Name>>,
    time: Res<Time>,
) {
