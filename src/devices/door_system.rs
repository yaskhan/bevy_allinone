...
/// Single door panel information
#[derive(Debug, Clone, Reflect)]
pub struct SingleDoorInfo {
    /// Door mesh entity
    pub door_mesh: Option<Entity>,
    
    /// Opened position entity (for translation)
    pub opened_position: Option<Entity>,
    pub opened_position_found: bool,
    
    /// Rotated position entity (for rotation)
    pub rotated_position: Option<Entity>,
    pub rotated_position_found: bool,
    
    /// Original position (for translation)
    pub original_position: Vec3,
    
    /// Original rotation (for rotation)
...
pub struct DoorSystem {
    /// Door panels information
    pub doors_info: Vec<SingleDoorInfo>,
    
    /// Tags that can open the door
    ...
    /// Open sound
    pub open_sound: Option<Handle<AudioSource>>,
    
    /// Close sound
    pub close_sound: Option<Handle<AudioSource>>,
    ...
    pub current_player_transform: Option<Entity>,
    ...
    /// Hologram door manager
    pub hologram_door: Option<Entity>,
    
    /// Device string action manager
    pub device_string_action: Option<Entity>,
    
    /// Map object information manager
    pub map_object_information: Option<Entity>,
}
...
impl Default for DoorSystem {
    fn default() -> Self {
        Self {
            ...
            movement_type: DoorMovementType::default(),
            open_sound: None,
            close_sound: None,
            door_type_info: DoorType::default(),
            door_state: DoorCurrentState::default(),
            locked: false,
