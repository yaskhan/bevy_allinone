...
pub mod melee_shield_on_inventory;
pub mod melee_weapon_consumable_on_inventory;
pub mod melee_weapon_on_inventory;
pub mod object_on_inventory;
pub mod oxygen_on_inventory;
pub mod shield_on_inventory;
pub mod stamina_on_inventory;
pub mod vehicle_fuel_on_inventory;
...
pub use melee_shield_on_inventory::MeleeShieldOnInventory;
pub use melee_weapon_consumable_on_inventory::MeleeWeaponConsumableOnInventory;
pub use melee_weapon_on_inventory::MeleeWeaponOnInventory;
pub use object_on_inventory::ObjectOnInventory;
pub use oxygen_on_inventory::OxygenOnInventory;
pub use shield_on_inventory::ShieldOnInventory;
pub use stamina_on_inventory::StaminaOnInventory;
pub use vehicle_fuel_on_inventory::VehicleFuelOnInventory;
