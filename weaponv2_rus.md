Ниже представлено **Техническое задание (ТЗ)** на рефакторинг и расширение текущей системы вооружения (на базе Bevy) с целью интеграции продвинутой баллистики.
